...
print("\033[92mInstalling!\033[0m")

import os
from libs.install import *
...
workspaces_path: str = option("Where do you want to save your workspaces? Enter the directory", "~/.config/simple-workspaces/", "Other")
...
print("\033[93mCreating config file in /home/{os.getlogin()}/.config/simple-workspaces\033[0m")
create_dir(f"/home/{os.getlogin()}/.config/simple-workspaces")
create_file(f"/home/{os.getlogin()}/.config/simple-workspaces", "config", "# This is the config file, not intended to be edited manually, or edited in general, if you want to edit this file, use the Python installer at the original location.\n\nPATH={path}\WS_PATH={workspaces_path}\n")

#  create the binary (In development, we copy the binary, but in the future we'll move it.)

print("\033[93mCreating executable\033[0m")
os.system(f"sudo cp ./simple-workspaces {path}")

# Now, make it executable

print("\033[93mMaking it executable\033[0m")
